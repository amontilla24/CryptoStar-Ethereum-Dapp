...
contract StarNotary is ERC721("Alberto Montilla Star", "AMS") {
    ...
    // DONE - called appropriate ERC721 constructor
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(ownerOf(_tokenId1) == msg.sender || ownerOf(_tokenId2) == msg.sender, "You must own one of the exchanged");
        ...
        // **** Chose to use transferFrom, so approve() will need to be called by token owners for exchange to pass
